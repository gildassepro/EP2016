...
public class DateConvert implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object entity) {
		SimpleDateFormat print = new SimpleDateFormat("HH:mm:ss", FacesContext.getCurrentInstance().getExternalContext().getRequestLocale());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String uuid) {
    	SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss",FacesContext.getCurrentInstance().getExternalContext().getRequestLocale());
