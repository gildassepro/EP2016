...
public class XMLCalendarTimeToDate implements Converter {
	private Logger logger = Logger.getLogger(XMLCalendarToDate.class);
	
	@Override
    public String getAsString(FacesContext context, UIComponent component, Object entity) {
		SimpleDateFormat print = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss", FacesContext.getCurrentInstance().getExternalContext().getRequestLocale());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String uuid) {
    	SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss",FacesContext.getCurrentInstance().getExternalContext().getRequestLocale());
    	try {
